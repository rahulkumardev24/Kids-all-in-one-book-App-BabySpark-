      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          flexibleSpace: MathScreenAppBar(
              isTablet: isTablet(context), size: size, title: "Division"),
        ),
        ...
        body: Obx(() {
          ...
          /// ------- get current problem --------- ///
          final currentProblem = divisionController
              .divisionProblems[divisionController.currentProblemIndex.value];
            ...
            child: Column(
              children: [
                                ...
                                DragTarget<String>(
                                  builder: (context, accepted, rejected) {
                                    return Container(
                                      ...
                                      width: 8.h,
                                      decoration: BoxDecoration(
                                        color: divisionController.isCorrect.value ||
                                            accepted.isNotEmpty
                                            ? Colors.green
                                            : Colors.white,
                                      ...
                                      child: Center(
                                        child: divisionController.isCorrect.value ||
                                            accepted.isNotEmpty
                                            ? Text(
                                          correctAnswer,
                                          style: myTextStyle30(
                                  ...
                                  onAcceptWithDetails: (details) {
                                    divisionController.checkAnswer(details.data);
                                  },
                                ),
                              ],
                            ),
                ...
                LinearProgressIndicator(
                  minHeight: 1.h,
                  value: (divisionController.currentProblemIndex.value + 1) /
                  ...
                  children: divisionController.currentOptions.map((number) {
                    ...
                    return Draggable<String>(
                      ...
                      child: GestureDetector(
                        ...
                        (isSelected && divisionController.isCorrect.value)
                            ? Container(
                          width: 70,
                          height: 70,
                          decoration: BoxDecoration(
